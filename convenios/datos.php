            ...
            <tbody>
                    ...
                    ?>    
                        <tr>
                            ...
                            <th><a href="actualizar.php?id=<?php echo $row['universidad'] ?>" class="btn btn-info"> <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 172 172"
                            ...
                            <th><a href="delete.php?id=<?php echo $row['universidad'] ?>" class="btn btn-danger"> <img src="https://img.icons8.com/ultraviolet/30/000000/delete-sign.png"/></a></th>
                        </tr>
                    <?php  
                        }
                    ?>
